...
$(function () {
    $('#btn_load_atg_file').on('click', function () {
        let inputAtg = document.getElementById("input_atg_file")
        inputAtg.click();
    });

    $("#input_atg_file").change(function () {
        var formData = new FormData();
        var f = document.getElementById('input_atg_file');
